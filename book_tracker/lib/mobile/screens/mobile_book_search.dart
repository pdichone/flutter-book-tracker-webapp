...
class MobileBookSearchPage extends StatefulWidget {
  @override
  _MobileBookSearchPageState createState() => _MobileBookSearchPageState();
}
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    showDialog(
                      context: context,
                      builder: (context) {
                        return MobileSearchedBookDetailDialog(
                            book: book, collectionReference: _linkCollection);
                      },
                    );
                  },
                )
